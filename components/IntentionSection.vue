  ...
  <section>
    ...
    <div v-if="typeformIdLearn || typeformIdShare" class="mb-6">
      <div class="inline-flex rounded-md shadow m-1">
        <button :data-tf-popup="typeformIdLearn" data-tf-size="80"
          data-tf-iframe-props="title=High five an existing topic to learn" data-tf-medium="snippet"
      ...
      <div class="inline-flex rounded-md shadow m-1">
        <button :data-tf-popup="typeformIdShare" data-tf-size="80"
          data-tf-iframe-props="title=High five an existing topic to share" data-tf-medium="snippet"
    ...
    <div v-else>
      <div class="inline-flex rounded-md shadow m-1">
        <button :data-tf-popup="typeformIdFull" data-tf-size="80"
          data-tf-iframe-props="title=What you are most interested in?" data-tf-medium="snippet"
    ...
    <NavigationTabs :names="['Graph', 'List']" :icons="['project-diagram', 'list']">
      <template v-slot:tab-0>
        <GraphManualKey class="text-left" />
        <GraphManual :nodes="nodes" :edges="edges" />
      </template>
      <template v-slot:tab-1>
        <MostPopularSkillsSection :skills="skills">
