	...
	computed: {
		...
		states() {
			return [
				{
					component: FormIntro,
					introduction: 'Hi! 👋 This is an invitation to connect to other MozFest participants via skills, interests and fascinations.',
					followup: 'Your input will be used to connect you with other participants on Slack and will be shown on the MozFest Gradual page.',
					updateFunction: () => { }
				},
				{
