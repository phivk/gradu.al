<template>
  <div class="text-center max-w-7xl mx-auto">
    <SocialHead :title="indexPage.pageTitle || `${indexPage.communityName} · Here to learn`" />
    ...
    <CTASection :logoSrc="indexPage.logoSrc" :communityName="indexPage.communityName" :ctaHeading="indexPage.ctaHeading"
      :ctaButtonPrimary="indexPage.ctaButtonPrimary" :ctaButtonSecondary="indexPage.ctaButtonSecondary"
    ...
    <div v-for="season in seasons">
      <SessionsSection v-if="sessionsPerSeason[season].length" :sessions="sessionsPerSeason[season]"
        :calendarLink="indexPage.calendarLink" :index="sessionsIndexPerSeason[season]"
