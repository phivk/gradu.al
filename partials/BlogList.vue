    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="md:flex md:justify-between">
                ...
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >Create and Deploy a blog with Simple</AppLink
                    >
                  </h2>
                </header>
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >Getting started with Next.js</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >How to identify high-intent leads</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >Why we think Simple is good for developers</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >Getting started with Vue.js and Stripe</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >How to work with friendly APIs</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >Introducing the Testing Field Guide</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
            ...
            <article class="flex items-center py-4 border-b border-gray-200">
              <div>
                <header>
                  <h2 class="h4 mb-2">
                    <AppLink to="/blog-post" class="hover:underline"
                      >Community Digest: Summer Edition</AppLink
                    >
                  </h2>
                </header>
                <div class="text-lg text-gray-600 mb-4">
          ...
          <!-- Sidebar -->
          <aside
            class="relative mt-12 md:mt-0 md:w-64 md:ml-12 lg:ml-20 md:flex-shrink-0"
          >
            <!-- Popular posts -->
            <div class="mb-8">
            ...
            <div>
              ...
              <ul class="-my-2">
                <li class="flex py-2 border-b border-gray-200">
                  ...
                  >
                    <path
                      d="M2.99 15h2.02l.429-3h3.979l-.428 3h2.02l.429-3H14v-2h-2.275l.575-4H15V4h-2.418l.428-3h-2.02l-.429 3H6.582l.428-3H4.99l-.429 3H2v2h2.275L3.7 10H1v2h2.418l-.428 3zM6.3 6h3.979L9.7 10H5.725L6.3 6z"
                    />
                  </svg>
