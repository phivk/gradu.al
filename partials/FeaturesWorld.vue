      ...
      <div class="py-12 md:py-20">
        ...
        <div class="flex flex-col items-center pt-12 md:pt-16">
          <div class="relative">
            ...
            <!-- Avatars -->
            <img class="absolute max-w-full transform animate-float" :src="require('@/images/planet-avatar-01.png')" width="261" height="105" alt="Planet avatar 01" style="width: 65.25%; top: -3%; right: -27%;" />
            <img class="absolute max-w-full transform animate-float animation-delay-1000" :src="require('@/images/planet-avatar-02.png')" width="355" height="173" alt="Planet avatar 02" style="width: 88.7%; bottom: -20%; right: -18%;" />
            <!-- Black icon -->
